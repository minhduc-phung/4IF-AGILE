...
/**
 * this class defines the points on the map called intersections
 * (it occurs as two road segments cross, defined by a latitude and a longitude and is modeled as a node in a graph)
 */
